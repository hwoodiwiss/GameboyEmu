...
Window::Window(HINSTANCE appInstance, bool runThreaded)
{
	WNDCLASSEX winDesc;
	...
	if (!runThreaded)
	{
		...
		m_wndHandle = CreateWindowEx(WS_EX_CLIENTEDGE, "WindowClass", "test", WS_OVERLAPPEDWINDOW, CW_USEDEFAULT, CW_USEDEFAULT, 500, 500, NULL, NULL, appInstance, this);
...
{
	m_wndHandle = CreateWindowEx(WS_EX_CLIENTEDGE, "WindowClass", "test", WS_OVERLAPPEDWINDOW, CW_USEDEFAULT, CW_USEDEFAULT, 500, 500, NULL, NULL, exInstance, this);
